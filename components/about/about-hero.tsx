      ...
      <div className="absolute inset-y-0 right-0 w-full md:w-2/3 lg:w-1/2 z-0">
        <div className="h-full w-full">
          ...
          <img
            ...
            style={{
              clipPath: 'ellipse(70% 70% at 70% 30%)' // Adjust ellipse to match screenshot shape
            }}
          />
        </div>
      </div>
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-2 md:px-8 flex flex-col md:flex-row items-start">
  <div className="w-full md:w-[48%] py-12 md:py-24 pr-0 md:pr-12 text-left md:items-start flex flex-col">
    <h1 className="text-4xl md:text-5xl font-bold text-green-700 mb-4 max-w-xl md:ml-0">
      Who We Are At Palm Group
    </h1>
    <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-lg md:ml-0">
