        ...
        <div className="w-full lg:w-1/2 bg-white rounded-xl shadow-md p-8">
          ...
          <div className="flex items-center text-gray-900 mb-4 text-base md:text-lg leading-relaxed">
            ...
            <span>
              ...
              /{" "}
              <a href="tel:+919821133714" className="hover:underline">
                +91 9821133714
              </a>
            </span>
          </div>
          ...
          <div className="flex items-start text-gray-900 mb-4 text-base md:text-lg leading-relaxed">
            ...
            <div>
              ...
              <a href="mailto:aman.shah@palmgrp.com" className="hover:underline block">
                aman.shah@palmgrp.com
              </a>
              <a href="mailto:vikas@palmgrp.com" className="hover:underline block">
                vikas@palmgrp.com
              </a>
            </div>
          </div>
